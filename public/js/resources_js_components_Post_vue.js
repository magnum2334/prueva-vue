...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    destroy: function destroy(id) {
      axios["delete"](this.urlDelete + id).then(console.log(Response));
      this.ListPost();
    }
  }
});
...
var render = function () {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c(
        "div",
        { staticClass: " col-4 my-4 text-center" },
        [
          _c(
            "div",
            { staticClass: "card-tilte" },
            [
              _c(
                "router-link",
                {
          ...
          _vm._l(_vm.heroes, function (hero) {
            return _c(
              "div",
              _vm._b(
                { key: hero.id, staticClass: "card my-3" },
                "div",
                hero,
                false
              ),
              [
                ...
                _c("div", { staticClass: "card-body" }, [
                  _c("div", [_vm._v(_vm._s(hero.power))]),
                ]),
                _vm._v(" "),
                _c(
                  "div",
                  ...
                  [
                    ...
                    _c(
                      "router-link",
                      {
                        ...
                        attrs: {
                          to: { name: "Edit", params: { id: hero.id } },
                        },
                      },
                      [_vm._v("Edit")]
                    ),
